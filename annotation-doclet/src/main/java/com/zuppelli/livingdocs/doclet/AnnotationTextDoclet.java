...
/**
 * Doclet que genera un archivo de texto usando la libreria qox.
 */
public class AnnotationTextDoclet
{
    ...
    private AnnotationTextDoclet( PrintWriter writer )
    {
        this.writer = writer;
    }

    public AnnotationTextDoclet begin()
    {
    ...
    public static boolean start(RootDoc root)
    {
        ...
        AnnotationTextDoclet doclet = null;
        try
        {
            doclet = new AnnotationTextDoclet(new PrintWriter("glossary.txt")).begin();
