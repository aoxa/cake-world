...
public class AnnotationBuilderDoclet
{
    ...
    private AnnotationBuilderDoclet( PrintWriter writer )
    {
        this.writer = writer;
    }

    public AnnotationBuilderDoclet begin()
    {
    ...
    {
        AnnotationBuilderDoclet doclet = null;
        try
        {
            doclet = new AnnotationBuilderDoclet(new PrintWriter("glossary.txt")).begin();
            doclet.process(root);
