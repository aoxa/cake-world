...
import com.zuppelli.living.docs.render.JClass;
import com.zuppelli.living.docs.render.JDerived;
import com.zuppelli.living.docs.render.JMethod;
...
public class AnnotationHTMLDoclet
{
    ...
    public AnnotationHTMLDoclet( PrintWriter writer )
    {
        root = new HashMap<>(  );
        try
        {
